...
✔ 반려동물과 이용자들의 데이터를 차트화하여 시각화하는 데이터 분석 서비스입니다..<br>
📽 중간 시연 영상 : https://www.youtube.com/watch?v=9caRKdyAJHk <br>
📽 최종 시연 영상 : https://www.youtube.com/watch?v=jCgy8_ebc6c <br>
...
|관리자 서비스|전체 회원과 예약 리스트를 보여주고 펫, 펫시터, 보호자의 정보를 차트화하고 시각화합니다. |
...
|[이정수](https://github.com/2cleanwater)|- 펫시터 상세 정보 서비스 구현 <br>- 예약 등록 기능 구현 <br>- 카카오 맵 API 서비스 구현 <br>- 관리자 데이터 시각화 서비스 구현|
|[설태혁](https://github.com/seoltaehyeok)|- spring security를 사용해 로그인, 회원가입 구현 <br>- 로그인, 회원가입 제약 조건 구현 <br>- 회원 탈퇴 구현 <br>- 펫시터-보호자 매칭 로직 및 페이지 구현 <br>- 관리자 페이지 회원 및 예약 정보 조회|
|[김선화](https://github.com/hhhhhsh)|- spring security를 사용해 로그인 보안 설계 구현 <br>- 회원가입 제약 조건 구현 <br>- index 페이지 구현|
|[이정운](https://github.com/wjddns0882)|- 커뮤니티 게시판 등록, 조회, 수정, 삭제 <br>- 커뮤니티 게시판 댓글 구현 <br>- 문서 작업 <br>- 리뷰서비스 구현 |
|[김귀영](https://github.com/Onlwu)|- 고객센터 자주 찾는 질문 페이지 구현 <br>- 고객센터 1:1 문의 서비스 구현 <br>- 1:1 문의 페이지 관리자, 유저 권한 설정 <br>- 1:1 문의 페이지 파일 업로드, 다운로드 <br>- QueryDSL 레포지토리 운영 <br>- admin 권한 설정|
